  ...
  return (
    <Container className='about' id='about'>
      ...
      <div className="about-text">
        ...
        <p>For me, the challenge of pushing myself to learn new skills in other fields outside of software development has been very beneficial as it allows me to weave my past knowledge and apply them to business challenges.</p>
        <p>I recently decided to move back to the development side of business these days, working on projects using Go/Golang, Google Cloud Platform (GCP), and cutting-edge frontend frameworks such as React and Svelte.</p>
      </div>
    </Container>
  )
}

  ...
  return (
    <Container className='about' id='about'>
      ...
      <div className="about-text">
        ...
        <p>I recently decided to move back and focus on software development, working on web projects using cutting edge technology such as Go(Golang), Google Cloud Platform (GCP), and modern frontend frameworks such as React and Svelte.</p>
      </div>
    </Container>
  )
}

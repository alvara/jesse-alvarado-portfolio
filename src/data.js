  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        title: "Main Features",
        details: `<ul>\n
        <li>User Roles system for certain users to change status of documents</li>\n
        <li>Generate document ID's according to the company's existing incremental formula</li>\n
        <li>System wide currency conversion for automatic  profit margin calculation based on supplier.</li>\n
        <li>Generate live preview of documents with Japanese seal on approved documents</li>\n
        <li>Automated export of documents to their local server via Rsync</li>\n
        </ul>`,
        top_imgs: [],
        right_imgs: [],
        bottom_imgs: [],
      ...
      },
      {
        ...
        top_imgs: [],
        right_imgs: [],
        bottom_imgs: ["/portfolio-img/beams-erp/design-dfd.png","/portfolio-img/beams-erp/whiteboard1.png"],
        left_imgs: []
      },
      {
